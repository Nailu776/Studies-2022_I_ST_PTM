...
class VersusActivity: AppCompatActivity(), View.OnClickListener{
    ...
    private fun junkRows() {
        //0 oznacza brak wysłanych klocków
        if(SocketHandler.read.equals("0")){
            return
        }
        //czytamy ile wierszy mamy dodać
        val number = SocketHandler.read!!.toIntOrNull()
        //zerujemy liczbę wierszy
        SocketHandler.read = "0"
        //
        if(number == null){
            return
        }
    ...
    private fun findAllViewsById(){
        ...
        gameGridView = findViewById(R.id.game_gridV)
        leftMoveView = findViewById(R.id.leftV)
        downMoveView = findViewById(R.id.downV)
        rightMoveView = findViewById(R.id.rightV)
        rotateMoveView = findViewById(R.id.rotateV)
        pauseClickView = findViewById(R.id.pauseV)
        resumeClickView = findViewById(R.id.resumeV)
        gameOver = findViewById(R.id.gameOverV)
        level = findViewById(R.id.levelV)
        totalScore = findViewById(R.id.totalScoreV)
        nextTetriminoCols4 = findViewById(R.id.nextBlock_4V)
        nextTetriminoCols5 = findViewById(R.id.nextBlock_5V)
        highScoreView = findViewById(R.id.high_scoreV)
    }
